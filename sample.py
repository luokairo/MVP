...
vae_ckpt, var_ckpt = '/fs/scratch/PAS2473/MM2025/neurpis2025/ckpt/var/vae_ch160v4096z32.pth', f'/fs/scratch/PAS2473/MM2025/neurpis2025/VAR/local_output_c2i_d{MODEL_DEPTH}/ar-ckpt-last.pth'
...
os.makedirs('/fs/scratch/PAS2473/MM2025/neurpis2025/VAR/output_samples—test', exist_ok=True)
# 分别保存每张图片
for i in range(B):
    single_img_path = f'/fs/scratch/PAS2473/MM2025/neurpis2025/VAR/output_samples—test/sample_seed{seed}_img{i}.png'
...
# 同时保存网格图以便对比
output_path = f'/fs/scratch/PAS2473/MM2025/neurpis2025/VAR/output_samples—test/sample_seed{seed}_grid.png'
