...
class VARTrainer(object):
    ...
    def eval_ep(self, ld_val: DataLoader):
        ...
        for inp_B3HW, label_B, inp_clip in ld_val:
    ...
    def train_step(
        ...
        with self.var_opt.amp_ctx:
            ...
            img_half_embedding = self.clip.encode_image(img_half)
            img_embedding = self.clip.encode_image(img)
